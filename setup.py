...
setup(
    ...
    description="A blog like plugin",  # Optional
    ...
    url="https://github.com/caibingcheng/orlike",  # Optional
    # This should be your name or the name of the organization which owns the
    # project.
    author="caibingcheng",  # Optional
    # This should be a valid email address corresponding to the author listed
    # above.
    author_email="jack_cbc@163.com",  # Optional
    ...
    # larger catalog.
    keywords="plugin, orlike, blog",  # Optional
